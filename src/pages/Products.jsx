...
export const Products = () => {
  ...
  return (
    <>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm">
                    Allow to soak for 2-3 minutes for optimal performance.
                  </p>
                </motion.div>
      ...
      {/* Product Showcase Section - BMA Bond */}
            ...
            >
              ...
              <div className="space-y-6">
                ...
                >
                  <h4 className="font-bold text-gray-800 mb-1">Storage</h4>
                  <p className="text-gray-600 text-sm">
                    Seal the container tightly after use to preserve the
      ...
      {/* Product Showcase Section - BMA Screeding Paint */}
      <section className="py-16 md:py-24 px-4 sm:px-6 md:px-10 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center mb-16">
            {/* Product Information */}
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Effectively fills gaps, cracks, and rough patches.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Works well on a variety of surfaces, ensuring long-lasting
                      results.
                    </p>
                  </div>
                </motion.div>
